...
public class CredentialMediator {
   ...
   */
  public CredentialMediator(RequestModel request,
   ...
   *                                 address was null.
   */
  public Userinfo getUserInfo(Credential credential)
    ...
    //modding user id for my own stupid purposes
    String userId = userInfo.getId() ;
    userId = modifyUserIdByScope(userId, this.scopes);
  ...
  public Credential getActiveCredential() throws NoRefreshTokenException, IOException {
    String userId = (String) request.getUserId();
    ...
    try {
      ...
      if ((credential == null || credential.getRefreshToken() == null)
        ...
        credential = exchangeCode(request.getCode());
        if (credential != null) {
  ...
  // Stupid utility function to change user id to store in credential store
  public  static String modifyUserIdByScope(String userId,Collection<String> scopes){
	if(scopes.equals(CloudSearchService.USER_SCOPES)){
